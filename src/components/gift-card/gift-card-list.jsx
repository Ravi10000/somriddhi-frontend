...
const giftCardsData = [
  ...
  },
  {
    _id: 2,
    title: "Amazon",
    image: "/gift-cards/congratulations.png",
    price: "500",
    description: "Amazon gift card",
  },
  {
  ...
  },
  {
    _id: 4,
    title: "Amazon",
    image: "/gift-cards/thank you.png",
    price: "2000",
    description: "Amazon gift card",
  },
];
...
function GiftCardList() {
  ...
  async function handleFetchGiftCards() {
    try {
      ...
      setGiftCards(demoResponse.data);
    } catch (err) {
      console.log(err);
    }
  }
